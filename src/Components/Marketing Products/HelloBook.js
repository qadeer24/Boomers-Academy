...
const HelloBook = ({ LoginisActive, SignUpisActive, LoginClick, SignUpClick, overlayIsActive }) => {
        ...
        <>
            ...
            <div className="marketing-product">
                ...
                <div className='marketing-product-text'>
                    <p><Link className='marketing-product-text-Link' to={'/'}>Home</Link> / <Link className='marketing-product-text-Link' to={'/'}>Uncategorized</Link> / 2024 Hello Boomer Book</p>
                    <Link className='marketing-product-uncategorized-link'>Uncategorized</Link>
                    <h3>2024 Hello Boomer Book</h3>
                    <h4>$ 0,00</h4>
