...
const BoomersPens = ({ LoginisActive, SignUpisActive, LoginClick, SignUpClick, overlayIsActive }) => {
        ...
        <>
            ...
            <div className="marketing-product">
                ...
                <div className='marketing-product-text'>
                    <p><Link className='marketing-product-text-Link' to={'/'}>Home</Link> / <Link className='marketing-product-text-Link' to={'/'}>Uncategorized</Link> / Boomers Pen for events</p>
                    <Link className='marketing-product-uncategorized-link'>Uncategorized</Link>
                    <h3>Boomers Pen for events</h3>
                    <h4>$ 0,00</h4>
